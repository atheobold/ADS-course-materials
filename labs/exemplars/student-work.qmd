...
tax_rev <- read_csv('https://atheobold.github.io/ADS-course-materials/labs/instructions/data/ca_tax_revenue.csv')
...
There were a couple of small changes people made to their tables for Lab 9 that I thought went the extra mile. Here are a couple of them!

## Consistent Capitalization

It seems like a small change, but I really appreciated how Elise Donaho changed the capitalization of the data type column so every word had consistent capitalization (instead of Date being the only capital letter).
...
Another small change that Nick Carboni (and few others) made was to add commas to the numbers in the missing value table. There were a couple of ways to add the colors to the table:
